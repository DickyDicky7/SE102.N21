...
Scene::Scene() : Entity(), HasTextures(), HasSprites(), HasAnimations(), state(NULL), updateState(NULL), handleInputState(NULL), stage(NULL), livesLeft(new INT(3)), currentStage(0), currentScore(0), highestScore(20000), stageIsReady(false)
{
