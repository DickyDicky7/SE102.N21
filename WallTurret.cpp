...
void AutoIncreasePositionSpriteLoader(
	...
	std::vector<WALL_TURRET_SPRITES_ID>,
	TEXTURE_ID
);
void AutoInscreaseSpriteIdLoadAnimations(std::vector<WALL_TURRET_SPRITES_ID>, ANIMATION_ID);
...
#pragma region WALL_TURRET_LEFT_30 SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::LEFT_30_01, WALL_TURRET_SPRITES_ID::LEFT_30_02, WALL_TURRET_SPRITES_ID::LEFT_30_03},
...
#pragma region WALL_TURRET_LEFT_60 SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::LEFT_60_01, WALL_TURRET_SPRITES_ID::LEFT_60_02, WALL_TURRET_SPRITES_ID::LEFT_60_03},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
	);
...
#pragma region WALL_TURRET_LEFT_90 SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::LEFT_90_01, WALL_TURRET_SPRITES_ID::LEFT_90_02, WALL_TURRET_SPRITES_ID::LEFT_90_03},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
	);
...
#pragma region WALL_TURRET_LEFT_120 SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::LEFT_120_01, WALL_TURRET_SPRITES_ID::LEFT_120_02, WALL_TURRET_SPRITES_ID::LEFT_120_03},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
	);
...
#pragma region WALL_TURRET_LEFT_150 SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::LEFT_150_01, WALL_TURRET_SPRITES_ID::LEFT_150_02, WALL_TURRET_SPRITES_ID::LEFT_150_03},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
	);
...
#pragma region WALL_TURRET_RIGHT_30 SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::RIGHT_30_01, WALL_TURRET_SPRITES_ID::RIGHT_30_02, WALL_TURRET_SPRITES_ID::RIGHT_30_03},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
	);
...
#pragma region WALL_TURRET_RIGHT_60 SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::RIGHT_60_01, WALL_TURRET_SPRITES_ID::RIGHT_60_02, WALL_TURRET_SPRITES_ID::RIGHT_60_03},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
	);
...
#pragma region WALL_TURRET_RIGHT_90 SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::RIGHT_90_01, WALL_TURRET_SPRITES_ID::RIGHT_90_02, WALL_TURRET_SPRITES_ID::RIGHT_90_03},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
	);
...
#pragma region WALL_TURRET_RIGHT_120 SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::RIGHT_120_01, WALL_TURRET_SPRITES_ID::RIGHT_120_02, WALL_TURRET_SPRITES_ID::RIGHT_120_03},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
	);
...
#pragma region WALL_TURRET_RIGHT_150 SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::RIGHT_150_01, WALL_TURRET_SPRITES_ID::RIGHT_150_02, WALL_TURRET_SPRITES_ID::RIGHT_150_03},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
	);
...
#pragma region WALL_TURRET_UP SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::UP_01, WALL_TURRET_SPRITES_ID::UP_02, WALL_TURRET_SPRITES_ID::UP_03},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
	);
...
#pragma region WALL_TURRET_DOWN SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::DOWN_01, WALL_TURRET_SPRITES_ID::DOWN_02, WALL_TURRET_SPRITES_ID::DOWN_03},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
	);
...
#pragma region WALL_TURRET_APPEAR SPRITE
	...
	AutoIncreasePositionSpriteLoader(
		...
		std::vector<WALL_TURRET_SPRITES_ID>
	{
		WALL_TURRET_SPRITES_ID::APPEAR_01,
			WALL_TURRET_SPRITES_ID::APPEAR_02,
			WALL_TURRET_SPRITES_ID::APPEAR_03,
			WALL_TURRET_SPRITES_ID::APPEAR_04,
			WALL_TURRET_SPRITES_ID::APPEAR_05,
			WALL_TURRET_SPRITES_ID::APPEAR_06,
	},
		WALL_TURRET_TEXTURE_ID::WALL_TURRET
			);
...
#pragma region LOAD LEFT ANIMATIONS
	...
	AutoInscreaseSpriteIdLoadAnimations(
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::LEFT_30_01, WALL_TURRET_SPRITES_ID::LEFT_30_02, WALL_TURRET_SPRITES_ID::LEFT_30_03},
		WALL_TURRET_ANIMATIONS_ID::LEFT_30
	);

	AutoInscreaseSpriteIdLoadAnimations(
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::LEFT_60_01, WALL_TURRET_SPRITES_ID::LEFT_60_02, WALL_TURRET_SPRITES_ID::LEFT_60_03},
		WALL_TURRET_ANIMATIONS_ID::LEFT_60
	);

	AutoInscreaseSpriteIdLoadAnimations(
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::LEFT_90_01, WALL_TURRET_SPRITES_ID::LEFT_90_02, WALL_TURRET_SPRITES_ID::LEFT_90_03},
		WALL_TURRET_ANIMATIONS_ID::LEFT_90
	);

	AutoInscreaseSpriteIdLoadAnimations(
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::LEFT_120_01, WALL_TURRET_SPRITES_ID::LEFT_120_02, WALL_TURRET_SPRITES_ID::LEFT_120_03},
		WALL_TURRET_ANIMATIONS_ID::LEFT_120
	);

	AutoInscreaseSpriteIdLoadAnimations(
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::LEFT_150_01, WALL_TURRET_SPRITES_ID::LEFT_150_02, WALL_TURRET_SPRITES_ID::LEFT_150_03},
		WALL_TURRET_ANIMATIONS_ID::LEFT_150
	);
...
#pragma region LOAD RIGHT ANIMATIONS
	...
	AutoInscreaseSpriteIdLoadAnimations(
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::RIGHT_30_01, WALL_TURRET_SPRITES_ID::RIGHT_30_02, WALL_TURRET_SPRITES_ID::RIGHT_30_03},
		WALL_TURRET_ANIMATIONS_ID::RIGHT_30
	);

	AutoInscreaseSpriteIdLoadAnimations(
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::RIGHT_60_01, WALL_TURRET_SPRITES_ID::RIGHT_60_02, WALL_TURRET_SPRITES_ID::RIGHT_60_03},
		WALL_TURRET_ANIMATIONS_ID::RIGHT_60
	);

	AutoInscreaseSpriteIdLoadAnimations(
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::RIGHT_90_01, WALL_TURRET_SPRITES_ID::RIGHT_90_02, WALL_TURRET_SPRITES_ID::RIGHT_90_03},
		WALL_TURRET_ANIMATIONS_ID::RIGHT_90
	);

	AutoInscreaseSpriteIdLoadAnimations(
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::RIGHT_120_01, WALL_TURRET_SPRITES_ID::RIGHT_120_02, WALL_TURRET_SPRITES_ID::RIGHT_120_03},
		WALL_TURRET_ANIMATIONS_ID::RIGHT_120
	);

	AutoInscreaseSpriteIdLoadAnimations(
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::RIGHT_150_01, WALL_TURRET_SPRITES_ID::RIGHT_150_02, WALL_TURRET_SPRITES_ID::RIGHT_150_03},
		WALL_TURRET_ANIMATIONS_ID::RIGHT_150
	);
...
#pragma region LOAD DOWN ANIMATIONS
	...
	AutoInscreaseSpriteIdLoadAnimations(
		std::vector<WALL_TURRET_SPRITES_ID>{WALL_TURRET_SPRITES_ID::DOWN_01, WALL_TURRET_SPRITES_ID::DOWN_02, WALL_TURRET_SPRITES_ID::DOWN_03},
		WALL_TURRET_ANIMATIONS_ID::DOWN
	);
...
#pragma region LOAD APPEAR ANIMATIONS
		...
		std::vector<WALL_TURRET_SPRITES_ID>
	{
		...
		WALL_TURRET_ANIMATIONS_ID::APPEAR
			);
...
#pragma region LOAD CLOSE ANIMATIONS
		...
		std::vector<WALL_TURRET_SPRITES_ID>
	{
		...
		WALL_TURRET_ANIMATIONS_ID::CLOSE
			);
...
void AutoIncreasePositionSpriteLoader(
	...
	std::vector<WALL_TURRET_SPRITES_ID> spriteIdList,
...
void AutoInscreaseSpriteIdLoadAnimations(std::vector<WALL_TURRET_SPRITES_ID> spriteIdList, ANIMATION_ID animationId)
{
