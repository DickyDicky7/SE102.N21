...
void Scene::LoadSprites()
{
	...
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_00, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_00);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_01, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_01);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_02, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_02);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_03, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_03);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_04, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_04);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_05, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_05);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_06, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_06);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_07, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_07);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_08, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_08);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_09, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_09);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_10, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_10);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_11, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_11);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_12, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_12);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_13, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_13);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_14, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_14);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_15, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_15);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_16, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_16);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_17, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_17);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_18, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_18);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_19, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_19);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_20, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_20);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_21, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_21);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_22, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_22);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_23, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_23);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_24, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_24);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_25, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_25);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_26, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_26);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_27, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_27);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_28, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_28);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_29, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_29);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_30, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_30);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_31, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_31);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_32, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_32);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_33, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_33);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_34, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_34);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_35, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_35);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_36, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_36);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_37, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_37);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_38, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_38);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_39, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_39);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_40, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_40);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_41, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_41);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_42, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_42);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_43, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_43);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_44, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_44);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_45, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_45);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_46, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_46);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_47, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_47);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_48, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_48);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_49, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_49);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_50, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_50);
	GraphicsHelper::InsertSprite(SCENE_SPRITE_ID::ENDING_FRAME_51, 000, 000, 256, 240, DIRECTION::LEFT, SCENE_TEXTURE_ID::ENDING_FRAME_51);
